...
public interface SearchBlService {
    ...
    BasicResponse advancedSearchByESWithHighLight(String author, String affiliation, String publicationName, String keyword, int startYear, int endYear, int page, String sortKey) throws Exception;
